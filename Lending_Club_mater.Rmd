...
```
Based on the graph, we can see a slightly negative correlation between interest rate and bond price.
...
```
However, when separated into lending grades, the negative correlation between interest rate and bond price becomes stronger in each grade. 
...
Although time trend is a significant variable in the previous model, it is not predictive in future trends of interest rates. Instead of using time as a variable, bond price has more explanatory power for the future. 
