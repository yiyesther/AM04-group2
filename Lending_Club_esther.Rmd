...
For the 5 and 15 fold cross validation, the rse will be the same, and therefore the rmse will also be the same. 
...
#quarter_break <- c("2007-2","2007-3","2008-1","2008-2","2008-3","2008-4",
                   #"2009-1","2009-2","2009-3","2009-4",
                   #"2010-1","2010-2","2010-3","2010-4",
                   #"20011-1","2011-2","2011-3")
...
as.numeric(difftime(temp$issue_d,min,units='days'))/30
temp <- temp %>% 
...
#The second model has a different linear time trend for each grade class
time2<-train(
    int_rate ~ loan_amnt + term + loan_amnt*grade + log(annual_inc) + cont_date + grade +grade:cont_date, #fill your variables here 
    temp,
   method = "lm",
    trControl = control
   )
